...
const getCommentsFromRealtimeDB = async () => {
  try {
    const res = await axios.get('https://bnews-4833f-default-rtdb.firebaseio.com/catagerious.json');
    const raw = res.data;
...
export default getCommentsFromRealtimeDB;
